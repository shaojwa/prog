...
#### 说明
这是一份性能组内的编码建议小册，目的是让代码能有更加一致的风格，使得组内代码更加易于维护。

#### 参考
这份主要的参考文档是 [Google C++ 编码规范](https://google.github.io/styleguide/cppguide.html)

## 代码最合适的位置
任何代码，都只是各种方案中的一种实现，大多数时候，并没有绝对的最优的选择。
但代码都有相对合理的位置，常想一想这个问题，会帮助我们写出更好的代码。
- 这个功能在哪个模块中实现最合适？
- 这行代码放在什么地方最合理？
...
#### 分支判断
- `if/else/while/for`等条件语句与左圆括号有空格，右圆括号和左大括号之间有空格。
